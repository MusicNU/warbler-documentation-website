...
const config: Config = {
    ...
    [
      "classic",
      {
        docs: {
          ...
          editUrl:
            "https://github.com/MusicNU/warbler-documentation-website/edit/main/",
        },
        blog: {
  ...
  themeConfig: {
    ...
    footer: {
      ...
      copyright: `Copyright © ${new Date().getFullYear()} Warbler, A Northwestern University Undergraduate Research Project. Built with Docusaurus.`,
    },
    prism: {
